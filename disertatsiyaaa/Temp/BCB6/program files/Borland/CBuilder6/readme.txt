...
and using the MFC examples
------------------------------

To update your existing CORBA applications to work with
C++Builder 6, or to use the examples in the \CBuilder6\MFC
directory, you must change the Conditional Define option in
Project|Options to _USE_OLD_RW_STL.
...
* C++Builder 6 supports InterBase 5.6, 6.0, and 6.5. The
