...
#include <ToolWin.hpp>
//----------------------------------------------------------------------------
class TWin2kAppForm : public TForm
{
__published:
...
private:
	AnsiString FFileName;
        bool __fastcall FileSave(bool ChangeName);
public:
	virtual __fastcall TWin2kAppForm(TComponent *Owner);
};
//----------------------------------------------------------------------------
extern TWin2kAppForm *Win2kAppForm;
//----------------------------------------------------------------------------
#endif    
