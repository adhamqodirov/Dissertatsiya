...
// (DO NOT EDIT: machine generated header) 'dsnapcrba.pas' rev: 6.00
...
#include <OrbPas.hpp>	// Pascal unit
#include <corbacon.hpp>	// Pascal unit
#include <CorbCnst.hpp>	// Pascal unit
#include <CorbaStd.hpp>	// Pascal unit
#include <CorbaRdm.hpp>	// Pascal unit
#include <CorbaObj.hpp>	// Pascal unit
