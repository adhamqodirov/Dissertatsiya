...
// (DO NOT EDIT: machine generated header) 'tee.pas' rev: 6.00
...
#include <TeeAbout.hpp>	// Pascal unit
#include <TeePrevi.hpp>	// Pascal unit
#include <TeExport.hpp>	// Pascal unit
#include <BrushDlg.hpp>	// Pascal unit
#include <PenDlg.hpp>	// Pascal unit
